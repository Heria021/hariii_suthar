...
const SkillCard: React.FC<SkillCardProps> = ({ skill, bgClass }) => {
  ...
  return (
    ...
    >
      <div
        className="relative h-full p-4 rounded-xl border border-zinc-800/50
...
const SkillsSection: React.FC = () => {
  const skills: SkillCategory[] = config.skills;
          ...
          <div className="max-w-2xl mx-auto text-center space-y-6">
            ...
            <motion.div variants={itemAnimation} className="space-y-2">
              ...
              <p className="text-lg text-muted-foreground">
                ...
                various development domains and tools.
              </p>
            </motion.div>
          </div>
